    ...
    >
        ...
        <div
          onClick={() =>
            handleOpenModal({
              ...
              github:
                "https://github.com/01omkamal/local-community-service-project",
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-gray-400 mb-4 text-sm line-clamp-3">
              A PHP & MySQL based service booking platform that connects users
              with local service providers and allows admins to manage bookings
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl max-w-3xl w-full relative">
